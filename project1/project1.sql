...
COMMENT ON COLUMN "MEMBER"."MEMBER_TEL" IS '휴대폰번호(바없이, 국제번호로 할시 11+3)';
...
COMMENT ON COLUMN "BOARD"."BOARD_CODE" IS '게시판 코드번호';
...
COMMENT ON COLUMN "COMMENT"."COMMENT_DEL_FL" IS '댓글 삭제여부(N: 삭제X, Y: 삭제O)';

COMMENT ON COLUMN "COMMENT"."BOARD_NO" IS '댓글 작성자 게시글 번호';
...
'user01@kh.or.kr', 'pass01!','유저일','01012341111','04540,,서울시 중구 남대문로 120,,2층',
DEFAULT,DEFAULT,DEFAULT,DEFAULT);
INSERT INTO "MEMBER" VALUES(SEQ_MEMBER_NO.NEXTVAL, 
'user02@kh.or.kr', 'pass02!','유저이','01012342222','04540,,서울시 중구 남대문로 120,,3층',
DEFAULT,DEFAULT,DEFAULT,DEFAULT);
